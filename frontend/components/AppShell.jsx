...
const customerNavigation = [['Loadlyx Connect','/app/connect','route'],['Overview','/app/dashboard','chart'],['My loads','/loads','route'],['Offers','/app/marketplace-offers','spark'],['Agreements & payments','/app/marketplace-transactions','chart'],['Post a load','/loadboard?post=1#marketplace','spark'],['Marketplace','/loadboard','search'],['Store','/catalog','store']];
